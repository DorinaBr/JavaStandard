...
public class StreamsPractice {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products = Arrays.asList(new Product("Phone", 999.9999), new Product("Laptop", 2499.9999), new Product("Gadget", 450.25));
    ...
    private static void printProcessesNumbers(List<Integer> integerList) {
        integerList.stream()
    ...
    private static void printIncreasedPrices(List<Product> productList) {
    ...
    private static void printEvenNumbersWithStream(List<Integer> numbers) {
        List<Integer> evenNumberStream = numbers.stream()
                .filter(number -> number % 2 == 0)
                .toList();
        System.out.println("Stream approach: " + evenNumberStream);
    }
